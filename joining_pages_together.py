...
class Bus_Service:
    ...
    def first_page(self):
        ...
        Label(self.root,text="Created by: Gantavya Rathore",fg="Dark Blue",font=(fontFam,20)).pack(pady=20)
        Label(self.root,text="github: https://github.com/Gantavya2",fg="Dark Blue",font=(fontFam,20)).pack(pady=20)
        Label(self.root,text="linkedin: https://www.linkedin.com/in/gantavya-rathore-322564376/",fg="Dark Blue",font=(fontFam,20)).pack(pady=20)
